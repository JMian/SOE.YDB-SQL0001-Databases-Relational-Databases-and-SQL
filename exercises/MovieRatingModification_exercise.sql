/*** Solution for SQL Movie-Rating Modification Exercises ***/

/*** SQL Movie-Rating Modification - Solution ***/
...
/* Q3. Remove all ratings where the movie's year is before 1970 or after 2000, 
